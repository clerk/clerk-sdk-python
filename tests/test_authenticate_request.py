...
@pytest.mark.asyncio
async def test_async_missing_jwt_key_returns_signed_out(session_token):
    request = MockRequest(headers=make_headers(auth_token=session_token))
    opts = AuthenticateRequestOptions(secret_key=None, jwt_key=None)
    state = await authenticate_request_async(request, opts)
    assert state.status == AuthStatus.SIGNED_OUT
...
@pytest.mark.asyncio
@patch("clerk_backend_api.security.authenticaterequest.verify_token_async", new_callable=AsyncMock)
async def test_async_valid_v2_token_without_org(mock_verify_token, session_token, default_options_with_secret_key):
    mock_verify_token.return_value = {
        "sub": "user_123",
        "v": 2,
        "fea": "u:foo,u:bar",
...
@pytest.mark.asyncio
@patch("clerk_backend_api.security.authenticaterequest.verify_token_async", new_callable=AsyncMock)
async def test_async_valid_v2_token_without_org_with_jwt_key(mock_verify_token, session_token, default_options_with_jwt_key):
    mock_verify_token.return_value = {
        "sub": "user_123",
        "v": 2,
        "fea": "u:foo,u:bar",
...
@pytest.mark.asyncio
@patch("clerk_backend_api.security.authenticaterequest.verify_token_async", new_callable=AsyncMock)
async def test_async_valid_v2_token_with_org_permissions_with_jwt_key(mock_verify_token, session_token, default_options_with_jwt_key):
    mock_verify_token.return_value = {
        "sub": "user_123",
        "v": 2,
        "fea": "o:admin,o:reports",
...
@pytest.mark.asyncio
@patch("clerk_backend_api.security.authenticaterequest.verify_token_async", new_callable=AsyncMock)
async def test_async_if_no_token_type_is_passed_then_any_token_type_is_accepted(mock_verify_token, session_token, default_options_with_jwt_key):
    mock_verify_token.return_value = {
        "sub": "user_123",
        "v": 2,
        "fea": "o:admin,o:reports",
...
@pytest.mark.asyncio
@patch("clerk_backend_api.security.authenticaterequest.verify_token_async", new_callable=AsyncMock)
async def test_async_oauth_machine_token(mock_verify_token):
    mock_verify_token.return_value = {
      "object": "clerk_idp_oauth_access_token",
      "id": "oat_0ef5a7a33d87ed87ee7954c845d80450",
      "client_id": "client_2xhFjEI5X2qWRvtV13BzSj8H6Dk",
...
@pytest.mark.asyncio
@patch("clerk_backend_api.security.authenticaterequest.verify_token_async", new_callable=AsyncMock)
async def test_async_api_key_machine_auth_token(mock_verify_token):
    mock_verify_token.return_value = {
      "object": "api_key",
      "id": "ak_3beecc9c60adb5f9b850e91a8ee1e992",
      "type": "api_key",
...
@pytest.mark.asyncio
@patch("clerk_backend_api.security.authenticaterequest.verify_token_async", new_callable=AsyncMock)
async def test_async_api_key_machine_auth_token_with_org_subject(mock_verify_token):
    """Test that API key with org_ prefixed subject maps to org_id, not user_id."""
    mock_verify_token.return_value = {
      "object": "api_key",
      "id": "ak_3beecc9c60adb5f9b850e91a8ee1e992",
...
@pytest.mark.asyncio
@patch("clerk_backend_api.security.authenticaterequest.verify_token_async", new_callable=AsyncMock)
async def test_async_m2m_machine_auth_token(mock_verify_token):
    mock_verify_token.return_value = {
      "object": "machine_to_machine_token",
      "id": "m2m_2xhFjEI5X2qWRvtV13BzSj8H6Dk",
      "subject": "mch_2xhFjEI5X2qWRvtV13BzSj8H6Dk",
...
@pytest.mark.asyncio
@patch("clerk_backend_api.security.authenticaterequest.verify_token_async", new_callable=AsyncMock)
async def test_async_m2m_machine_auth_token_with_secret_key(mock_verify_token):
    mock_verify_token.return_value = {
        "object": "machine_to_machine_token",
        "id": "mt_2xhFjEI5X2qWRvtV13BzSj8H6Dk",
        "subject": "mch_2xhFjEI5X2qWRvtV13BzSj8H6Dk",
...
@pytest.mark.asyncio
@patch("clerk_backend_api.security.authenticaterequest.verify_token_async", new_callable=AsyncMock)
async def test_async_m2m_token_with_machine_secret_key(mock_verify_token):
    mock_verify_token.return_value = {
        "object": "machine_to_machine_token",
        "id": "mt_2xhFjEI5X2qWRvtV13BzSj8H6Dk",
        "subject": "mch_2xhFjEI5X2qWRvtV13BzSj8H6Dk",
