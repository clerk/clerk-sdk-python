...
class OAuthApplicationsSDK(BaseSDK):
    ...
    async def list_o_auth_applications_async(
        self, *,
        limit: Optional[int] = 10,
        offset: Optional[int] = 0,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
    ...
    def create_o_auth_application(
        self, *,
        request: Optional[Union[models.CreateOAuthApplicationRequestBody, models.CreateOAuthApplicationRequestBodyTypedDict]] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ...
    async def create_o_auth_application_async(
        self, *,
        request: Optional[Union[models.CreateOAuthApplicationRequestBody, models.CreateOAuthApplicationRequestBodyTypedDict]] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
    ...
    async def get_o_auth_application_async(
        self, *,
        oauth_application_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
    ...
    async def update_o_auth_application_async(
        self, *,
        oauth_application_id: str,
        name: Optional[str] = None,
        callback_url: Optional[str] = None,
    ...
    async def delete_o_auth_application_async(
        self, *,
        oauth_application_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
    ...
    def rotate_o_auth_application_secret(
        self, *,
        oauth_application_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
    ...
    async def rotate_o_auth_application_secret_async(
        self, *,
        oauth_application_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
