...
class RedirectURLs(BaseSDK):
    ...
    async def list_redirect_ur_ls_async(
        self, *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ...
    def create_redirect_url(
        self, *,
        request: Optional[Union[models.CreateRedirectURLRequestBody, models.CreateRedirectURLRequestBodyTypedDict]] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ...
    async def create_redirect_url_async(
        self, *,
        request: Optional[Union[models.CreateRedirectURLRequestBody, models.CreateRedirectURLRequestBodyTypedDict]] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
    ...
    async def get_redirect_url_async(
        self, *,
        id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
    ...
    async def delete_redirect_url_async(
        self, *,
        id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
