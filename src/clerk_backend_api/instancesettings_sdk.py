...
class InstanceSettingsSDK(BaseSDK):
    ...
    def get_communication(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.InstanceCommunication:
        r"""Get instance communication settings
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.InstanceCommunication, http_res)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.SDKError("API error occurred", http_res, http_res_text)
        if utils.match_response(http_res, "5XX", "*"):
    ...
    async def get_communication_async(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
    ...
    def update_communication(
        ...
        *,
        request: Optional[
            Union[
                models.UpdateInstanceCommunicationRequestBody,
                models.UpdateInstanceCommunicationRequestBodyTypedDict,
            ]
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        ...
        r"""Update instance communication settings
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(
                request, Optional[models.UpdateInstanceCommunicationRequestBody]
            )
        request = cast(Optional[models.UpdateInstanceCommunicationRequestBody], request)
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                True,
                "json",
                Optional[models.UpdateInstanceCommunicationRequestBody],
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
    ...
    async def update_communication_async(
        self,
        *,
        request: Optional[
            Union[
    ...
    def get_o_auth_application_settings(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.OAuthApplicationSettings:
        r"""Get OAuth application settings
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.OAuthApplicationSettings, http_res)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.SDKError("API error occurred", http_res, http_res_text)
        if utils.match_response(http_res, "5XX", "*"):
    ...
    async def get_o_auth_application_settings_async(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
    ...
    def update_o_auth_application_settings(
        self,
        *,
        request: Optional[
            Union[
                models.UpdateInstanceOAuthApplicationSettingsRequestBody,
                models.UpdateInstanceOAuthApplicationSettingsRequestBodyTypedDict,
            ]
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        ...
        r"""Update OAuth application settings
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(
                request,
                Optional[models.UpdateInstanceOAuthApplicationSettingsRequestBody],
            )
        request = cast(
            Optional[models.UpdateInstanceOAuthApplicationSettingsRequestBody], request
        )
    ...
    async def update_o_auth_application_settings_async(
        self,
        *,
        request: Optional[
            Union[
    ...
    def get_organization_settings(
        ...
        *,
        ...
        r"""Get instance organization settings
    ...
    def get_instance_protect(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.InstanceProtect:
        r"""Get instance protect settings
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.InstanceProtect, http_res)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.SDKError("API error occurred", http_res, http_res_text)
        if utils.match_response(http_res, "5XX", "*"):
    ...
    async def get_instance_protect_async(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
    ...
    def update_instance_protect(
        ...
        *,
        ...
        r"""Update instance protect settings
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(
                request, Optional[models.UpdateInstanceProtectRequestBody]
            )
        request = cast(Optional[models.UpdateInstanceProtectRequestBody], request)
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                True,
                "json",
                Optional[models.UpdateInstanceProtectRequestBody],
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
    ...
    async def update_instance_protect_async(
        self,
        *,
        request: Optional[
            Union[
