...
class OrganizationMembershipsSDK(BaseSDK):
    ...
    async def update_organization_membership_async(
        self, *,
        organization_id: str,
        user_id: str,
        role: str,
    ...
    def update_organization_membership_metadata(
        self, *,
        organization_id: str,
        user_id: str,
    ...
    async def update_organization_membership_metadata_async(
        self, *,
        organization_id: str,
        user_id: str,
        public_metadata: Optional[Union[models.UpdateOrganizationMembershipMetadataPublicMetadata, models.UpdateOrganizationMembershipMetadataPublicMetadataTypedDict]] = None,
    ...
    def instance_get_organization_memberships(
        self, *,
        limit: Optional[int] = 10,
        offset: Optional[int] = 0,
        order_by: Optional[str] = None,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="InstanceGetOrganizationMemberships", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.OrganizationMemberships])
        if utils.match_response(http_res, ["400","401","422","500"], "application/json"):
            data = utils.unmarshal_json(http_res.text, models.ClerkErrorsData)
            raise models.ClerkErrors(data=data)
        if utils.match_response(http_res, ["4XX","5XX"], "*"):
            raise models.SDKError("API error occurred", http_res.status_code, http_res.text, http_res)
    ...
    async def instance_get_organization_memberships_async(
        self, *,
        limit: Optional[int] = 10,
        offset: Optional[int] = 0,
        order_by: Optional[str] = None,
