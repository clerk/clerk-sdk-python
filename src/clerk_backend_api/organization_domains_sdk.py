...
class OrganizationDomainsSDK(BaseSDK):
    ...
    def create_organization_domain(
        ...
        req = self.build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(request.request_body, False, False, "json", models.CreateOrganizationDomainRequestBody),
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="CreateOrganizationDomain", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.OrganizationDomain])
    ...
    async def create_organization_domain_async(
        self, *,
        organization_id: str,
        name: Optional[str] = None,
        enrollment_mode: Optional[str] = None,
    ...
    def list_organization_domains(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="ListOrganizationDomains", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.OrganizationDomains])
    ...
    async def list_organization_domains_async(
        self, *,
        organization_id: str,
        limit: Optional[int] = 10,
        offset: Optional[int] = 0,
    ...
    def delete_organization_domain(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="DeleteOrganizationDomain", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
    ...
    async def delete_organization_domain_async(
        self, *,
        organization_id: str,
        domain_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
