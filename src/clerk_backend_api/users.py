...
class Users(BaseSDK):
    ...
    def create(
        ...
        *,
        ...
        if utils.match_response(
            http_res, ["400", "401", "402", "403", "422"], "application/json"
        ):
            response_data = unmarshal_json_response(models.ClerkErrorsData, http_res)
            raise models.ClerkErrors(response_data, http_res)
        if utils.match_response(http_res, "4XX", "*"):
    ...
    def bulk_ban(
        ...
        *,
        ...
        :param user_ids: Array of user IDs to ban
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
    ...
    def bulk_unban(
        ...
        *,
        ...
        :param user_ids: Array of user IDs to unban
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
        ...
        *,
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                True,
                "json",
                Optional[models.ReplaceUserMetadataRequestBody],
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
    ...
    def get_billing_subscription(
        ...
        *,
        ...
        request = models.GetUserBillingSubscriptionRequest(
            user_id=user_id,
        )
    ...
    def get_billing_credit_balance(
        ...
        *,
        ...
        r"""Retrieve a user's credit balance
        ...
        request = models.GetUserBillingCreditBalanceRequest(
            user_id=user_id,
        )
    ...
    def adjust_billing_credit_balance(
        ...
        *,
        ...
        r"""Adjust a user's credit balance
        ...
        request = models.AdjustUserBillingCreditBalanceRequest(
            user_id=user_id,
