...
class WaitlistEntriesSDK(BaseSDK):
    ...
    def bulk_create(
        ...
        *,
        ...
        r"""Create multiple waitlist entries
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(
                request, Optional[List[models.CreateBulkWaitlistEntriesRequestBody]]
            )
        request = cast(
            Optional[List[models.CreateBulkWaitlistEntriesRequestBody]], request
        )
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                True,
                "json",
                Optional[List[models.CreateBulkWaitlistEntriesRequestBody]],
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(List[models.WaitlistEntry], http_res)
        if utils.match_response(http_res, ["400", "422"], "application/json"):
            response_data = unmarshal_json_response(models.ClerkErrorsData, http_res)
            raise models.ClerkErrors(response_data, http_res)
        if utils.match_response(http_res, "4XX", "*"):
