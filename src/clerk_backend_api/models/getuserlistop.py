...
class GetUserListRequestTypedDict(TypedDict):
    ...
    """
    last_sign_in_at_before: NotRequired[int]
    r"""Returns users whose last sign-in was before the given date (with millisecond precision).
    Example: use 1700690400000 to retrieve users whose last sign-in was before 2023-11-23.
    """
    last_sign_in_at_after: NotRequired[int]
    r"""Returns users whose last sign-in was after the given date (with millisecond precision).
    Example: use 1700690400000 to retrieve users whose last sign-in was after 2023-11-23.
    """
    provider: NotRequired[str]
    r"""Returns users with external accounts for the specified OAuth provider.
    ...
    """
    provider_user_id: NotRequired[List[str]]
    r"""Returns users with the specified provider user IDs for a specific provider.
...
class GetUserListRequest(BaseModel):
    ...
    last_sign_in_at_before: Annotated[
        Optional[int],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Returns users whose last sign-in was before the given date (with millisecond precision).
    ...
    last_sign_in_at_after: Annotated[
        Optional[int],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Returns users whose last sign-in was after the given date (with millisecond precision).
