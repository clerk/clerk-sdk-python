...
class PayerType(str, Enum):
    r"""Filter plans by payer type"""

    USER = "user"
    ORG = "org"


class GetCommercePlanListRequestTypedDict(TypedDict):
    ...
    """
    payer_type: NotRequired[PayerType]
    r"""Filter plans by payer type"""


class GetCommercePlanListRequest(BaseModel):
    paginated: Annotated[
        Optional[bool],
    ...
    def serialize_model(self, handler):
        optional_fields = set(["paginated", "limit", "offset", "payer_type"])
