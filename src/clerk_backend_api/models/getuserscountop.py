...
class GetUsersCountRequestTypedDict(TypedDict):
    ...
    r"""Counts users whose last sign-in was before the given date (with millisecond precision).
    Example: use 1700690400000 to count users whose last sign-in was before 2023-11-23.
    """
    last_sign_in_at_after: NotRequired[int]
    r"""Counts users whose last sign-in was after the given date (with millisecond precision).
    Example: use 1700690400000 to count users whose last sign-in was after 2023-11-23.
    """
    provider: NotRequired[str]
    r"""Counts users with external accounts for the specified OAuth provider.
    ...
    r"""Counts users with the specified provider user IDs for a specific provider.
