...
class ListRoleSetsRequestTypedDict(TypedDict):
    query: NotRequired[str]
    r"""Returns role sets with ID, name, or key that match the given query.
    Uses exact match for role set ID and partial match for name and key.
    """
    order_by: NotRequired[str]
    r"""Allows to return role sets in a particular order.
...
class ListRoleSetsRequest(BaseModel):
    query: Annotated[
        Optional[str],
