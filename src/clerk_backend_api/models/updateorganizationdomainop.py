...
class UpdateOrganizationDomainRequestBody(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = ["enrollment_mode", "verified"]
        nullable_fields = ["enrollment_mode", "verified"]
        null_default_fields = []
...
class UpdateOrganizationDomainRequest(BaseModel):
    ...
    r"""The ID of the domain"""
    request_body: Annotated[UpdateOrganizationDomainRequestBody, FieldMetadata(request=RequestMetadata(media_type="application/json"))]
