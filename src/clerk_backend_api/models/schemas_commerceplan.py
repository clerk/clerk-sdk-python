...
class SchemasCommercePlanFeeTypedDict(TypedDict):
    amount: int
...
class SchemasCommercePlanFee(BaseModel):
    amount: int
    r"""The amount in cents."""
...
class SchemasCommercePlanAnnualMonthlyFeeTypedDict(TypedDict):
    amount: int
    r"""The amount in cents."""
    amount_formatted: str
    r"""The formatted amount as a string (e.g., \"$49.99\")."""
...
class SchemasCommercePlanAnnualMonthlyFee(BaseModel):
    amount: int
    r"""The amount in cents."""
...
class SchemasCommercePlanAnnualFeeTypedDict(TypedDict):
    amount: int
    r"""The amount in cents."""
    amount_formatted: str
    r"""The formatted amount as a string (e.g., \"$49.99\")."""
...
class SchemasCommercePlanAnnualFee(BaseModel):
    amount: int
    r"""The amount in cents."""
...
class SchemasCommercePlanTypedDict(TypedDict):
    ...
    fee: Nullable[SchemasCommercePlanFeeTypedDict]
    annual_monthly_fee: Nullable[SchemasCommercePlanAnnualMonthlyFeeTypedDict]
    annual_fee: Nullable[SchemasCommercePlanAnnualFeeTypedDict]
    amount: int
...
class SchemasCommercePlan(BaseModel):
    ...
    fee: Nullable[SchemasCommercePlanFee]

    annual_monthly_fee: Nullable[SchemasCommercePlanAnnualMonthlyFee]

    annual_fee: Nullable[SchemasCommercePlanAnnualFee]
