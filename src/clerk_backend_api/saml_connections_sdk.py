...
class SAMLConnectionsSDK(BaseSDK):
    ...
    async def list_saml_connections_async(
        self, *,
        limit: Optional[int] = 10,
        offset: Optional[int] = 0,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
    ...
    async def create_saml_connection_async(
        self, *,
        request: Optional[Union[models.CreateSAMLConnectionRequestBody, models.CreateSAMLConnectionRequestBodyTypedDict]] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
    ...
    async def get_saml_connection_async(
        self, *,
        saml_connection_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
    ...
    async def update_saml_connection_async(
        self, *,
        saml_connection_id: str,
        name: OptionalNullable[str] = UNSET,
        domain: OptionalNullable[str] = UNSET,
    ...
    async def delete_saml_connection_async(
        self, *,
        saml_connection_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
