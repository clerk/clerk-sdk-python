...
class ExperimentalAccountlessApplications(BaseSDK):
    def create(
        self,
        *,
    ...
    ) -> Optional[models.AccountlessApplication]:
        r"""Create an accountless application [EXPERIMENTAL]
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, Optional[models.AccountlessApplication]
            )
    ...
    def complete(
        ...
        *,
        ...
        r"""Complete an accountless application [EXPERIMENTAL]
        ...
        req = self._build_request(
            method="POST",
            path="/accountless_applications/complete",
            base_url=base_url,
            url_variables=url_variables,
            request=None,
            request_body_required=False,
