...
class InstanceSettingsSDK(BaseSDK):
    ...
    def update_instance(
        self, *,
        request: Optional[Union[models.UpdateInstanceRequestBody, models.UpdateInstanceRequestBodyTypedDict]] = None,
    ...
    def update_instance_restrictions(
        self, *,
        request: Optional[Union[models.UpdateInstanceRestrictionsRequestBody, models.UpdateInstanceRestrictionsRequestBodyTypedDict]] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        if not isinstance(request, BaseModel) and request is not None:
            request = utils.unmarshal(request, models.UpdateInstanceRestrictionsRequestBody)
    ...
    async def update_instance_restrictions_async(
        self, *,
        request: Optional[Union[models.UpdateInstanceRestrictionsRequestBody, models.UpdateInstanceRestrictionsRequestBodyTypedDict]] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
    ...
    def update_instance_organization_settings(
        self, *,
        request: Optional[Union[models.UpdateInstanceOrganizationSettingsRequestBody, models.UpdateInstanceOrganizationSettingsRequestBodyTypedDict]] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        if not isinstance(request, BaseModel) and request is not None:
            request = utils.unmarshal(request, models.UpdateInstanceOrganizationSettingsRequestBody)
    ...
    async def update_instance_organization_settings_async(
        self, *,
        request: Optional[Union[models.UpdateInstanceOrganizationSettingsRequestBody, models.UpdateInstanceOrganizationSettingsRequestBodyTypedDict]] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
