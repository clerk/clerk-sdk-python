...
class JWTTemplates(BaseSDK):
    ...
    async def list_jwt_templates_async(
        self, *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ...
    async def create_jwt_template_async(
        self, *,
        request: Optional[Union[models.CreateJWTTemplateRequestBody, models.CreateJWTTemplateRequestBodyTypedDict]] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
    ...
    async def get_jwt_template_async(
        self, *,
        template_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
    ...
    async def update_jwt_template_async(
        self, *,
        template_id: str,
        request_body: Optional[Union[models.UpdateJWTTemplateRequestBody, models.UpdateJWTTemplateRequestBodyTypedDict]] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
    ...
    async def delete_jwt_template_async(
        self, *,
        template_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
