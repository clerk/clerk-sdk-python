...
class OrganizationDomainSDK(BaseSDK):
    ...
    def update_organization_domain(
        ...
        req = self.build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(request.request_body, False, False, "json", models.UpdateOrganizationDomainRequestBody),
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="UpdateOrganizationDomain", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
    ...
    async def update_organization_domain_async(
        self, *,
        organization_id: str,
        domain_id: str,
        enrollment_mode: OptionalNullable[str] = UNSET,
