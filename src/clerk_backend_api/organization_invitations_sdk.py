...
class OrganizationInvitationsSDK(BaseSDK):
    ...
    def list_instance_organization_invitations(
        self, *,
    ...
    async def list_instance_organization_invitations_async(
        self, *,
        limit: Optional[int] = 10,
        offset: Optional[int] = 0,
        order_by: Optional[str] = "-created_at",
    ...
    async def list_organization_invitations_async(
        self, *,
        organization_id: str,
        limit: Optional[int] = 10,
        offset: Optional[int] = 0,
    ...
    def create_organization_invitation_bulk(
        self, *,
        organization_id: str,
    ...
    async def create_organization_invitation_bulk_async(
        self, *,
        organization_id: str,
        request_body: Union[List[models.RequestBody], List[models.RequestBodyTypedDict]],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
    ...
    @deprecated("warning: ** DEPRECATED ** - This will be removed in a future release, please migrate away from it as soon as possible.")
    async def list_pending_organization_invitations_async(
        self, *,
        organization_id: str,
        limit: Optional[int] = 10,
        offset: Optional[int] = 0,
    ...
    async def revoke_organization_invitation_async(
        self, *,
        organization_id: str,
        invitation_id: str,
        request_body: Optional[Union[models.RevokeOrganizationInvitationRequestBody, models.RevokeOrganizationInvitationRequestBodyTypedDict]] = None,
