...
class Commerce(BaseSDK):
    ...
    def list_subscription_items(
        ...
        *,
        ...
        :param user_id: Filter subscription items by user ID
        :param organization_id: Filter subscription items by organization ID
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
    ...
    def extend_subscription_item_free_trial(
        ...
        *,
        ...
        :param extend_to: RFC3339 timestamp to extend the free trial to. Must be in the future and not more than 365 days from now.
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
        ...
        request = models.ExtendCommerceSubscriptionItemFreeTrialRequest(
            subscription_item_id=subscription_item_id,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="ExtendCommerceSubscriptionItemFreeTrial",
                oauth2_scopes=[],
                security_source=self.sdk_configuration.security,
            ),
            request=req,
