...
class Billing(BaseSDK):
        ...
        *,
    ...
    ) -> Optional[models.SchemasCommerceSubscriptionItem]:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                Optional[models.SchemasCommerceSubscriptionItem], http_res
            )
    ...
    def list_statements(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> Optional[models.PaginatedBillingStatementResponse]:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                Optional[models.PaginatedBillingStatementResponse], http_res
            )
    ...
    def get_statement(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> Optional[models.BillingStatement]:
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(Optional[models.BillingStatement], http_res)
        if utils.match_response(
    ...
    def get_statement_payment_attempts(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> Optional[models.PaginatedBillingPaymentAttemptResponse]:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                Optional[models.PaginatedBillingPaymentAttemptResponse], http_res
            )
        if utils.match_response(
            http_res, ["400", "401", "404", "422"], "application/json"
        ):
